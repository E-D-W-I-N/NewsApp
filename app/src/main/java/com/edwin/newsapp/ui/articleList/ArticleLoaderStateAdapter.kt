...
import com.edwin.newsapp.databinding.ItemErrorBinding

class ArticleLoaderStateAdapter : LoadStateAdapter<ArticleLoaderStateAdapter.ItemViewHolder>() {
    ...
    class ProgressViewHolder internal constructor(
        binding: FragmentArticleListBinding
